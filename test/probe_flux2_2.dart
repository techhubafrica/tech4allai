...
void main() async {
  final endpoints = [
    'https://fal.run/fal-ai/flux-pro/max',
    'https://fal.run/fal-ai/flux/max',
    'https://fal.run/fal-ai/flux.2-max',
    'https://fal.run/fal-ai/flux-2.0/max',
    'https://fal.run/black-forest-labs/flux.2-max',
    'https://fal.run/black-forest-labs/flux-2-max',
    'https://fal.run/fal-ai/flux-pro/v2',
    'https://fal.run/fal-ai/flux-v2',
    'https://fal.run/fal-ai/flux.2',
  ];
